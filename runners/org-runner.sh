...
REPO_URL="https://github.com/DEL-ORG"             #replace with organisation url
RUNNER_TOKEN="XXXXXXXXXXXXXXXXXXXXXXXXXX"         #use organistion token
RUNNER_LABELS="build,deploy,s8,s9"                #replace labels of choice
RUNNER_USER="runner"
RUNNER_COUNT=10
RUNNER_GROUP="DEL"                                #replace with runner group name or commet it out
